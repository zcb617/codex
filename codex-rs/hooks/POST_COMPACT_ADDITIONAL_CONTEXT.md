...
| 项 | 内容 |
|----|------|
| 分支 | `dev/from-rust-v0.144.4` |
| 能力提交 | `fee7872cf3` |
| 基于 tag | `rust-v0.144.4` |
...
```bash
git checkout dev/from-rust-v0.144.4
cd codex-rs
...
文档版本：与分支 `dev/from-rust-v0.144.4` 上 PostCompact 注入实现同步。若协议字段有演进，以 schema fixture 与代码为准更新本文。
